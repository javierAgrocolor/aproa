...
<?php if (isset($origenfecha[0]['producto'])) { ?>    
    ...
    <script type="text/javascript">
        ...
        google.charts.setOnLoadCallback(drawCalabacinOri);

        function drawCalabacinOri() {
    ...
    for ($x = 0; $x < count($origenfecha); $x++) {
        if ($origenfecha[$x]['cod_producto'] == 13) {
    ...
    for ($x = 0; $x < count($origensemana); $x++) {
        if ($origensemana[$x]['cod_producto'] == 13) {
    ...
    for ($x = 0; $x < count($origenyear); $x++) {
        if ($origenyear[$x]['cod_producto'] == 13) {
    ...
    ?>
            ...
            var options = {
                ...
                title: 'Calabacín - Precios en origen(€/kg)',
                vAxis: {title: 'Precio'},
                hAxis: {title: 'ALMERÍA'},
                colors: ["#749925", "#a1c15c", "#d5f297"],
                seriesType: 'bars'
            };

            var chart = new google.visualization.ComboChart(document.getElementById('chart_origen_calabacin'));
            chart.draw(view, options);
        }

        google.charts.setOnLoadCallback(drawCalabacinGordoOri);

        function drawCalabacinGordoOri() {
            // Some raw data (not necessarily accurate)
            var data = google.visualization.arrayToDataTable([
                ['', 'Última semana', 'Semana anterior', 'Última semana campaña pasada'],
    <?php
    ...
    $valido = false;
    for ($x = 0; $x < count($origenfecha); $x++) {
        if ($origenfecha[$x]['cod_producto'] == 39) {
            echo "[''," . sprintf("%.2f", round($origenfecha[$x]['precio'], 2)) . "";
            $valido = true;
        }
    }
    ...
    $valido = false;
    for ($x = 0; $x < count($origensemana); $x++) {
        if ($origensemana[$x]['cod_producto'] == 39) {
            echo "," . sprintf("%.2f", round($origensemana[$x]['precio'], 2)) . "";
            $valido = true;
        }
    }
    ...
    $valido = false;
    for ($x = 0; $x < count($origenyear); $x++) {
        if ($origenyear[$x]['cod_producto'] == 39) {
            echo "," . sprintf("%.2f", round($origenyear[$x]['precio'], 2)) . "]";
            $valido = true;
        }
    }
    ...
    ?>
            ...
            var options = {
                legend: {textStyle: {fontSize: '9'}, position: 'top'},
                title: 'Calabacín Gordo - Precios en origen(€/kg)',
                vAxis: {title: 'Precio'},
                hAxis: {title: 'ALMERÍA'},
                colors: ["#749925", "#a1c15c", "#d5f297"],
                seriesType: 'bars'
            ...
            var chart = new google.visualization.ComboChart(document.getElementById('chart_origen_cgordo'));
            chart.draw(view, options);
        }
...
<?php if (isset($mayoristasfechaesp[0]['producto']) || isset($mayoristasfechaale[0]['producto']) || isset($mayoristasfechafra[0]['producto']) || isset($mayoristasfecharei[0]['producto'])) { ?>
    <script type="text/javascript">
        ...
        google.charts.load('current', {'packages': ['corechart','table']});
        google.charts.setOnLoadCallback(drawCalabacinMay);


        function drawCalabacinMay() {
            // Some raw data (not necessarily accurate)
            var data = google.visualization.arrayToDataTable([
                ['', 'Última semana', 'Semana anterior', 'Última semana campaña pasada'],
           <?php 
//ESPAÑA - controlar fecha
    ...
    for ($x = 0; $x < count($mayoristasfechaesp); $x++) {
        if ($mayoristasfechaesp[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($mayoristassemanaesp); $x++) {
        if ($mayoristassemanaesp[$x]['cod_producto'] == 13 && $espana == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($mayoristasyearesp); $x++) {
        if ($mayoristasyearesp[$x]['cod_producto'] == 13 && $espana == true) {
...
//ALEMANIA - controlar fecha
    ...
    for ($x = 0; $x < count($mayoristasfechaale); $x++) {
        if ($mayoristasfechaale[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($mayoristassemanaale); $x++) {
        if ($mayoristassemanaale[$x]['cod_producto'] == 13 && $alemania == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($mayoristasyearale); $x++) {
        if ($mayoristasyearale[$x]['cod_producto'] == 13 && $alemania == true) {
    ...
    for ($x = 0; $x < count($mayoristasfechafra); $x++) {
        if ($mayoristasfechafra[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($mayoristassemanafra); $x++) {
        if ($mayoristassemanafra[$x]['cod_producto'] == 13 && $francia == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($mayoristasyearfra); $x++) {
        if ($mayoristasyearfra[$x]['cod_producto'] == 13 && $francia == true) {
    ...
    for ($x = 0; $x < count($mayoristasfecharei); $x++) {
        if ($mayoristasfecharei[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($mayoristassemanarei); $x++) {
        if ($mayoristassemanarei[$x]['cod_producto'] == 13 && $reinounido == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($mayoristasyearrei); $x++) {
        if ($mayoristasyearrei[$x]['cod_producto'] == 13 && $reinounido == true) {
    ...
    ?>          
            ...
            var options = {
                legend: {textStyle: {fontSize: '9'}, position: 'top'},
                title: 'Calabacín - Precios en mayoristas(€/kg)',
                vAxis: {title: 'Precio'},
                hAxis: {title: ''},
                colors: ["#749925", "#a1c15c", "#d5f297"],
                seriesType: 'bars'
            ...
            var chart = new google.visualization.ComboChart(document.getElementById('chart_mayoristas_calabacin'));
            chart.draw(view, options);
        }
...
<?php if (isset($mayoristasfechaorigen[0]['producto'])) { ?>
    <script type="text/javascript">
        ...
        google.charts.load('current', {'packages': ['corechart','table']});        
        google.charts.setOnLoadCallback(drawCalabacinMayOr);

        function drawCalabacinMayOr() {
            // Some raw data (not necessarily accurate)
            var data = google.visualization.arrayToDataTable([
                ['', 'Última semana', 'Semana anterior', 'Última semana campaña pasada'],
                <?php
                    ...
                    foreach ($mayoristasfechaorigen as $row) {
                        if($row['cod_producto']==13){
                            ...
                            foreach ($mayoristasyearorigen as $row3) {
                                 if($row3['cod_producto']==13 && $row3['cod_origen']==$origen){
            ...
            var options = {
                legend: {textStyle: {fontSize: '9'}, position: 'top'},
                title: 'Calabacín - Precios en mayoristas segun origen(€/kg)',
                vAxis: {title: 'Precio'},
                hAxis: {title: ''},
                colors: ["#749925", "#a1c15c", "#d5f297"],
                seriesType: 'bars'
            ...
            var chart = new google.visualization.ComboChart(document.getElementById('chart_mayoristas_origen_calabacin'));
            chart.draw(view, options);
        }
...
<?php if (isset($supermercadofechaesp[0]['producto']) || isset($supermercadofechaale[0]['producto']) || isset($supermercadofechafra[0]['producto']) || isset($supermercadofecharei[0]['producto'])) { ?>
    <script type="text/javascript">
        ...
        google.charts.load('current', {'packages': ['corechart','table']});
        google.charts.setOnLoadCallback(drawCalabacinSup);

        function drawCalabacinSup() {
            // Some raw data (not necessarily accurate)
            var data = google.visualization.arrayToDataTable([
                ['', 'Última semana', 'Semana anterior', 'Última semana campaña pasada'],
           <?php 
//ESPAÑA - controlar fecha
    ...
    for ($x = 0; $x < count($supermercadofechaesp); $x++) {
        if ($supermercadofechaesp[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($supermercadosemanaesp); $x++) {
        if ($supermercadosemanaesp[$x]['cod_producto'] == 13 && $espana == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($supermercadoyearesp); $x++) {
        if ($supermercadoyearesp[$x]['cod_producto'] == 13 && $espana == true) {
...
//ALEMANIA - controlar fecha
    ...
    for ($x = 0; $x < count($supermercadofechaale); $x++) {
        if ($supermercadofechaale[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($supermercadosemanaale); $x++) {
        if ($supermercadosemanaale[$x]['cod_producto'] == 13 && $alemania == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($supermercadoyearale); $x++) {
        if ($supermercadoyearale[$x]['cod_producto'] == 13 && $alemania == true) {
    ...
    for ($x = 0; $x < count($supermercadofechafra); $x++) {
        if ($supermercadofechafra[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($supermercadosemanafra); $x++) {
        if ($supermercadosemanafra[$x]['cod_producto'] == 13 && $francia == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($supermercadoyearfra); $x++) {
        if ($supermercadoyearfra[$x]['cod_producto'] == 13 && $francia == true) {
    ...
    for ($x = 0; $x < count($supermercadofechapol); $x++) {
        if ($supermercadofechapol[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($supermercadosemanapol); $x++) {
        if ($supermercadosemanapol[$x]['cod_producto'] == 13 && $polonia == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($supermercadoyearpol); $x++) {
        if ($supermercadoyearpol[$x]['cod_producto'] == 13 && $polonia == true) {
    ...
    for ($x = 0; $x < count($supermercadofecharei); $x++) {
        if ($supermercadofecharei[$x]['cod_producto'] == 13) {
...
//controlar semana
    ...
    for ($x = 0; $x < count($supermercadosemanarei); $x++) {
        if ($supermercadosemanarei[$x]['cod_producto'] == 13 && $reinounido == true) {
...
//controlar año
    ...
    for ($x = 0; $x < count($supermercadoyearrei); $x++) {
        if ($supermercadoyearrei[$x]['cod_producto'] == 13 && $reinounido == true) {
    ...
    ?>          
            ...
            var options = {
                legend: {textStyle: {fontSize: '9'}, position: 'top'},
                title: 'Calabacín - Precios en supermercados(€/kg)',
                vAxis: {title: 'Precio'},
                hAxis: {title: ''},
                colors: ["#749925", "#a1c15c", "#d5f297"],
                seriesType: 'bars'
            ...
            var chart = new google.visualization.ComboChart(document.getElementById('chart_supermercado_calabacin'));
            chart.draw(view, options);
        }
...
<?php if (isset($supermercadofechaorigen[0]['producto'])) { ?>
    <script type="text/javascript">
        ...
        google.charts.load('current', {'packages': ['corechart','table']});        
        google.charts.setOnLoadCallback(drawCalabacinSupOr);

        function drawCalabacinSupOr() {
            // Some raw data (not necessarily accurate)
            var data = google.visualization.arrayToDataTable([
                ['', 'Última semana', 'Semana anterior', 'Última semana campaña pasada'],
                <?php
            ...
            var options = {
                legend: {textStyle: {fontSize: '9'}, position: 'top'},
                title: 'Calabacín - Precios en supermercados segun origen(€/kg)',
                vAxis: {title: 'Precio'},
                hAxis: {title: ''},
                colors: ["#749925", "#a1c15c", "#d5f297"],
                seriesType: 'bars'
            ...
            var chart = new google.visualization.ComboChart(document.getElementById('chart_supermercado_origen_calabacin'));
            chart.draw(view, options);
        }
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="origen">
                 <div class="row margintop">    
                    <div class="col-md-12">
                    <div class="col-md-3">
                        <img src="/images/calabacin.png" class="img-responsive">  
                    </div>
                    <div class="col-md-1 paddingTop">
                        <?php echo "<a id='flechaIzquierda' href='" . Url::home() . "/productos/calabacin/?fechaorigen=" . $fechaorigen->sub(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechaorigen->format('Y-m-d') . "'><img src='/images/flechaIzquierda.png' /></a>"; ?>
                    </div>
                    ...
                    <div class='col-md-1 paddingTop'>
                        <?php echo "<a id='flechaDerecha' href='" . Url::home() . "/productos/calabacin/?fechaorigen=" . $fechaorigen->add(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechaorigen->format('Y-m-d') . "'><img src='/images/flechaDerecha.png' /></a>"; ?>
                    </div>
                    </div>
                </div>
                <div class="row margintop">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                if (isset($origenfecha[0]['producto'])) {
                                    echo '<div class="col-md-6" id="chart_origen_calabacin" style="width: 550px; height: 200px;"></div>';
                                    echo '<div class="col-md-6" id="chart_origen_cgordo" style="width: 550px; height: 200px;"></div>';
                                } else {
                        ...
                        <div class="table-responsive">                            
                            <table class="table-condensed">
                                ...
                                <tbody>
                                    ...
                                    <tr bgcolor="#f5f8ed">
                                        <td align="center">Calabacín Gordo</td>
                                        <td align="center">
                                            <?php
                                            $fechaPrecio = 0;
                                            $semanaPrecio = 0;
            ...
            <div role="tabpanel" class="tab-pane" id="mayoristas">
                <div class="row margintop">    
                    ...
                    <div class="col-md-1 paddingTop">
                        <?php echo "<a id='flechaIzquierda' href='" . Url::home() . "/productos/calabacin/?fechamayorista=" . $fechamayorista->sub(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechamayorista->format('Y-m-d') . "'><img src='/images/flechaIzquierda.png' /></a>"; ?>
                    </div>
                    <div class="col-md-6 paddingTop">
                        <p class="titulosProductos">Datos a mostrar: <?php echo $fechamayorista->add(new \DateInterval('P1D'))->format('d-m-Y'); ?></p>
                    </div>
                    <div class='col-md-1 paddingTop'>
                        <?php echo "<a id='flechaDerecha' href='" . Url::home() . "/productos/calabacin/?fechamayorista=" . $fechamayorista->add(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechamayorista->format('Y-m-d') . "'><img src='/images/flechaDerecha.png' /></a>"; ?>
                    </div>
                    </div>
                </div>
                <div class="row margintop">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                if (isset($mayoristasfechaesp[0]['producto']) || isset($mayoristasfechaale[0]['producto']) || isset($mayoristasfechafra[0]['producto']) || isset($mayoristasfecharei[0]['producto'])) {
                                    echo '<div class="col-md-6 col-md-offset-1" id="chart_mayoristas_calabacin" style="width: 950px; height: 200px;"></div>';
                                } else {
                                    echo '<div class="col-md-12"><p align="center">Aun no se han generado datos para este día.</p></div>';
                                }
                                ?>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                if (isset($mayoristasfechaorigen[0]['producto'])) {
                                    echo '<div class="col-md-6 col-md-offset-1" id="chart_mayoristas_origen_calabacin" style="width: 950px; height: 200px;"></div>';                                   
                                } else {
                                    echo '<div class="col-md-12"><p align="center">Aun no se han generado datos para este día.</p></div>';
                                }
                                ?>
            ...
            <div role="tabpanel" class="tab-pane" id="supermercados">
                <div class="row margintop">    
                    ...
                    <div class="col-md-1 paddingTop">
                        <?php echo "<a id='flechaIzquierda' href='" . Url::home() . "/productos/calabacin/?fechasupermercado=" . $fechasupermercado->sub(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechasupermercado->format('Y-m-d') . "'><img src='/images/flechaIzquierda.png' /></a>"; ?>
                    </div>
                    <div class="col-md-6 paddingTop">
                        <p class="titulosProductos">Datos a mostrar: <?php echo $fechasupermercado->add(new \DateInterval('P1D'))->format('d-m-Y'); ?></p>
                    </div>
                    <div class='col-md-1 paddingTop'>
                        <?php echo "<a id='flechaDerecha' href='" . Url::home() . "/productos/calabacin/?fechasupermercado=" . $fechasupermercado->add(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechasupermercado->format('Y-m-d') . "'><img src='/images/flechaDerecha.png' /></a>"; ?>
                    </div>
                    </div>
                </div>
                <div class="row margintop">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                if (isset($supermercadofechaesp[0]['producto']) || isset($supermercadofechaale[0]['producto']) || isset($supermercadofechafra[0]['producto']) || isset($supermercadofecharei[0]['producto'])){
                                    echo '<div class="col-md-6 col-md-offset-1" id="chart_supermercado_calabacin" style="width: 950px; height: 200px;"></div>';
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                if (isset($supermercadofechaorigen[0]['producto'])) {
                                    echo '<div class="col-md-6 col-md-offset-1" id="chart_supermercado_origen_calabacin" style="width: 950px; height: 200px;"></div>';     
