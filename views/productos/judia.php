        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="origen">
                <div class="row margintop">    
                    ...
                    <div class="col-md-1 paddingTop">
                        <?php echo "<a id='flechaIzquierda' href='" . Url::home() . "/productos/judia/?fechaorigen=" . $fechaorigen->sub(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechaorigen->format('Y-m-d') . "'><img src='/images/flechaIzquierda.png' /></a>"; ?>
                    </div>
                    ...
                    <div class='col-md-1 paddingTop'>
                        <?php echo "<a id='flechaDerecha' href='" . Url::home() . "/productos/judia/?fechaorigen=" . $fechaorigen->add(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechaorigen->format('Y-m-d') . "'><img src='/images/flechaDerecha.png' /></a>"; ?>
                    </div>
                    </div>
                </div>
                <div class="row margintop">
            ...
            <div role="tabpanel" class="tab-pane" id="mayoristas">
                <div class="row margintop">    
                    ...
                    <div class="col-md-1 paddingTop">
                        <?php echo "<a id='flechaIzquierda' href='" . Url::home() . "/productos/judia/?fechamayorista=" . $fechamayorista->sub(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechamayorista->format('Y-m-d') . "'><img src='/images/flechaIzquierda.png' /></a>"; ?>
                    </div>
                    <div class="col-md-6 paddingTop">
                        <p class="titulosProductos">Datos a mostrar: <?php echo $fechamayorista->add(new \DateInterval('P1D'))->format('d-m-Y'); ?></p>
                    </div>
                    <div class='col-md-1 paddingTop'>
                        <?php echo "<a id='flechaDerecha' href='" . Url::home() . "/productos/judia/?fechamayorista=" . $fechamayorista->add(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechamayorista->format('Y-m-d') . "'><img src='/images/flechaDerecha.png' /></a>"; ?>
                    </div>
                    </div>
                </div>
                <div class="row margintop">
            ...
            <div role="tabpanel" class="tab-pane" id="supermercados">
                <div class="row margintop">    
                    ...
                    <div class="col-md-1 paddingTop">
                        <?php echo "<a id='flechaIzquierda' href='" . Url::home() . "/productos/judia/?fechasupermercado=" . $fechasupermercado->sub(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechasupermercado->format('Y-m-d') . "'><img src='/images/flechaIzquierda.png' /></a>"; ?>
                    </div>
                    <div class="col-md-6 paddingTop">
                        <p class="titulosProductos">Datos a mostrar: <?php echo $fechasupermercado->add(new \DateInterval('P1D'))->format('d-m-Y'); ?></p>
                    </div>
                    <div class='col-md-1 paddingTop'>
                        <?php echo "<a id='flechaDerecha' href='" . Url::home() . "/productos/judia/?fechasupermercado=" . $fechasupermercado->add(new \DateInterval('P1D'))->format('Y-m-d') . "' value='" . $fechasupermercado->format('Y-m-d') . "'><img src='/images/flechaDerecha.png' /></a>"; ?>
                    </div>
                    </div>
                </div>
                <div class="row margintop">
